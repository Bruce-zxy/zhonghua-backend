...
$('.refresh-box').on('click', function(br) {
    ...
    var arr = [[1,2,3,4,5,6,7], ['X1', 'X2', 'X3', 'X4', 'X5', 'X6', 'X7'], [11,22,33,44,55,66,77]]
    
    arr.forEach(function (item, i) {
        // var td = d3.select('tbody').data(arr[i]).text(function (d) { return ''; });
        // var tr = td.enter().append('tr').text(function(d) { return '<td><'+d+'td>'; });
    })
});
